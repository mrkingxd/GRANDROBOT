...
TECHNO_IMG = "https://telegra.ph/file/09be5d55d41583121c5e2.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Mr_king_Xd")],
                                                                                   [InlineKeyboardButton(text="ADD Millie Bot TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Hey I Am Online Working Nicely")
